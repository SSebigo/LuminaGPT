...
import 'package:lumina_gpt/domain/agents/i_agents_repository.dart' as _i4;
import 'package:lumina_gpt/domain/settings/i_settings_repository.dart' as _i6;
import 'package:lumina_gpt/infrastructure/agents/agents_repository.dart' as _i5;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i4.IAgentsRepository>(
      () => _i5.AgentsRepository(gh<_i3.Isar>()),
      registerFor: {
        _dev,
        _prod,
      },
